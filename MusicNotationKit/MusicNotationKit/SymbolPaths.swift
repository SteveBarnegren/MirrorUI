...
class SymbolPaths {
    ...
    static let openNoteHead: Path = {
        ...
        let holeCommands: [Path.Command] = [
            .move(Point(-0.5613551633450389, -0.5)),
            .curve(Point(0.2614533679937976, -0.1428573600279716), c1: Point(-0.2896498989069793, -0.5), c2: Point(-0.015380672230583259, -0.38095285872820417)),
            .curve(Point(0.6843919064775543, 0.38888888888888884), c1: Point(0.5434107721074475, 0.09523753059394047), c2: Point(0.6843900822425928, 0.27248567215457353)),
            .curve(Point(0.5921141971085875, 0.5), c1: Point(0.6843900822425928, 0.46296134142077494), c2: Point(0.653631048479044, 0.49999878384335905)),
